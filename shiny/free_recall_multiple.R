  ...
  tabItem(tabName = "free_recall_multiple",
          fluidRow(
            ...
            box(
              ...
              p(" "),
              DTOutput("multiple_recall_participant"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}"),
              p(" "),
              ...
              p(" "),
              DTOutput("multiple_recall_group.by"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}")
            ...
            # Multiple Recall Graph ---------------------------------------------------------
            box(
              title = tags$b("Graphed Multiple Free-Recall Output"),
              collapsible = TRUE,
              solidHeader = TRUE,
              status = "primary",
              width = 12,
              ...
              p(" "),
              plotOutput("multiple_recall_graph"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}")
            ), # box
            ...
            box(
              ...
              p(" "),
              DTOutput("serial_data_output_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}"),
              p(" "),
              HTML("<b>Here's a graph of your results:</b>"),
              p(" "),
              plotOutput("serial_graph_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}")
            ), # box
            ...
            box(
              ...
              p(" "),
              DTOutput("pfr_data_output_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}"),
              p(" "),
              HTML("<b>Here's a graph of your results:</b>"),
              plotOutput("pfr_graph_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}")
            ), # box
            ...
            box(
              ...
              p(" "),
              DTOutput("crp_data_output_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}"),
              p(" "),
              HTML("<b>Here's a graph of your results:</b>"),
              plotOutput("crp_graph_multiple"),
              tags$style(type = "text/css",
                         ".shiny-output-error {visibility: hidden;}",
                         ".shiny-output-error:before {visibility: hidden;}")
            ) # box
