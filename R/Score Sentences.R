#' Sentence Match
#'
#' This function allows you to compute the number of matching words between two sentences stored in a dataframe.
...
#' @param cutoff a numerical value used for computing the percent match used at scoring. Must be a value between 0 and 1.
#' @keywords percent
#' @import dplyr
#' @import koRpus
